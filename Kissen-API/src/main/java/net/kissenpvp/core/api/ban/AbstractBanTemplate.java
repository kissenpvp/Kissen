...
public interface AbstractBanTemplate {
     ...
     * @see #setDuration(AccurateDuration)
     */
    @NotNull Optional<AccurateDuration> getDuration();
     ...
     * @see #getDuration()
     */
    void setDuration(@Nullable AccurateDuration duration) throws EventCancelledException;
