...
public interface AbstractGroupablePermissionEntry<T extends AbstractPermission> extends AbstractPermissionEntry<T> {
    ...
    @NotNull @Unmodifiable List<AbstractPermissionGroup<T>> getOwnPermissionGroups();
     ...
     */
    @NotNull @Unmodifiable List<AbstractPermissionGroup<T>> getPermissionGroups();
     ...
     */
    boolean inGroup(@NotNull AbstractPermissionGroup<T> permissionGroup);
}
