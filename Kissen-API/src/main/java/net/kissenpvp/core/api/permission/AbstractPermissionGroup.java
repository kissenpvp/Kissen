...
/**
 * A permission group is a group containing permissions and assigns them to the {@link AbstractPermissionEntry} which are members of it.
 *
 * @author Groldi
 * @since 1.0.0-SNAPSHOT
 */
public interface AbstractPermissionGroup<T extends AbstractPermission> extends AbstractGroupablePermissionEntry<T>
{
    /**
     ...
     */
    boolean addMember(@NotNull AbstractGroupablePermissionEntry<?> groupablePermissionEntry) throws PermissionGroupConflictException;
     ...
     */
    boolean removeMember(@NotNull AbstractGroupablePermissionEntry<?> groupablePermissionEntry);
