...
import net.kissenpvp.core.api.ban.event.PlayerBanEndUpdateEvent;
...
@Setter
public class KissenPlayerBanEndUpdateEvent implements PlayerBanEndUpdateEvent
{
    @Getter private final PlayerBan playerBan;
    private Long end;
    @Getter private boolean cancelled;

    public KissenPlayerBanEndUpdateEvent(@NotNull PlayerBan playerBan, @Nullable Long end)
    {
