 ...
 */
@Getter @Setter
public class BanRenameEvent<B extends Ban> extends BanEvent<B> {
     ...
     *
     * @param ban the {@link Ban} related to this ban alteration event. This parameter must not be null.
