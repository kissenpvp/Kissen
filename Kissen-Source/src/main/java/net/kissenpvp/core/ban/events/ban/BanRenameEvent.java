 ...
 */
@Getter @Setter
public class BanRenameEvent<B extends AbstractBanTemplate> extends BanEvent<B> {
     ...
     *
     * @param ban the {@link AbstractBanTemplate} related to this ban alteration event. This parameter must not be null.
