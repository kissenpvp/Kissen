 ...
 *
 * @param <P> The specific type of punishment managed by this event, this type extends {@link AbstractPunishment}
 *
 * @see PunishmentEvent
 * @see AbstractPunishment
 * @see NotNull
 */
public class PlayerPunishEvent<P extends AbstractPunishment<?>> extends PunishmentEvent<P> {

    /**
     * Constructs a new {@link PlayerPunishEvent} with the specified {@link AbstractPunishment}.
