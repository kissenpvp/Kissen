 ...
 */
@Setter
public class PunishmentAlterCauseEvent<P extends Punishment<?>> extends PunishmentEvent<P> {

    private final Component previousCause;
    private Component updatedCause;

    /**
     * Constructs a new {@link PunishmentAlterCauseEvent} with the specified {@link Punishment}, previous cause and new cause.
