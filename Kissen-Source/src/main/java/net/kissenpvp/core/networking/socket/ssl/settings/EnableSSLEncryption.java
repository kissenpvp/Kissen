...
public class EnableSSLEncryption extends OptionBoolean
{
    ...
    {
        return "\nDefines if the asynchronous messaging should be encrypted or not.";
    }

    @Override public @NotNull Boolean getDefault()
    {
        return false;
    }
