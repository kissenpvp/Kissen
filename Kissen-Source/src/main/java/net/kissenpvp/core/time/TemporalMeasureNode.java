 ...
 */
public record TemporalMeasureNode(long start, @NotNull Container<Long> duration, @NotNull Container<Long> end, @Nullable Long predictedEnd) {
     ...
     */
    public TemporalMeasureNode(@NotNull TemporalObject temporalObject) {
     ...
     */
    public TemporalMeasureNode(long start, @Nullable AccurateDuration accurateDuration) {
    ...
    public TemporalMeasureNode(@NotNull long start) {
        this(start, null);
    }

    public TemporalMeasureNode() {
