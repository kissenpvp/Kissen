...
public interface ConnectionProvider
{
     ...
     *
     * @return a {@link Optional} containing the active {@link Connection} if available, or an empty optional if no connection is present
     */
     ...
     * This behavior can be overridden by specifying {@code false} for the {@code generateSchema} parameter in {@link #connect(String, String, String, boolean)}.
     *
     ...
     */
    void connect(@NotNull String url, @NotNull String username, @NotNull String password) throws IllegalStateException, SQLException, NullPointerException;
     ...
     * @param username       the username for authenticating with the database; must not be null
     * @param password       the password for authenticating with the database; must not be null
     * @param generateSchema a boolean indicating whether the database schema should be generated; {@code true} to generate the schema, {@code false} otherwise
     * @throws IllegalStateException if a connection is already established
     * @throws SQLException          if a database access error occurs or the connection attempt fails
     * @throws NullPointerException  if any of the parameters are null
     * @see #connect(String, String, String)
     */
    void connect(@NotNull String url, @NotNull String username, @NotNull String password, boolean generateSchema) throws IllegalStateException, SQLException, NullPointerException;
